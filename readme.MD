Segue o README.md com correções de português e pequenas padronizações:
...
int main() {
    ...
    // Inicializa LED de demonstração
    gpio_init(LED_PIN);
    gpio_set_dir(LED_PIN, GPIO_OUT);

    // Inicializa Access Point Wi‑Fi
...
| `/mouse`  | **Mouse Tracker** | Envia coordenadas do mouse para o Pico e exibe no navegador. |
